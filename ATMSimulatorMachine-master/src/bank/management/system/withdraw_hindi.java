...
public class withdraw_hindi extends JFrame implements ActionListener {
    JButton withdraw, back;
    JTextField amount;
    String pinnumber;
    private JPanel keyboardPanel;

    public withdraw_hindi(String pinnumber) {
        ...
        JLabel text = new JLabel("वह राशि दर्ज करें जिसे आप निकालना चाहते हैं");
        ...
        JLabel text2 = new JLabel("निकालना");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == withdraw) {
            ...
            Date date = new Date();
            if (number.equals("")) {
                JLabel label4 = new JLabel("वह राशि दर्ज करें जिसे आप निकालना चाहते हैं");
